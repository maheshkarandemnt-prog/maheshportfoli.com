            ...
            <div className="container">
                <div className="footer-content">
                    <div className="footer-brand">
                        <a href="#home" className="footer-logo" onClick={(e) => handleNavClick(e, '#home')}>
                            ...
                            <span className="logo-name">ahesh Karande</span>
                        </a>
                    ...
                    <div className="footer-social">
                        ...
                        <div className="footer-social-links">
                            ...
                            <a href="https://github.com/maheshkarandemnt-prog" target="_blank" rel="noopener noreferrer" title="GitHub">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div className="footer-bottom">
                    <p className="copyright">
                        © {currentYear} Mahesh Karande. All rights reserved.
                    </p>
